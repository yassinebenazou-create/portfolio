...
const AdminLogin = () => {
    ...
    const handleGoogleLogin = async () => {
        ...
        const email = window.prompt("Enter your admin email to continue")?.trim();

        if (!email) {
            gooeyToast.error("Admin email is required.");
            return;
        }
        ...
        try {
            ...
            gooeyToast.error("Unable to continue to the admin dashboard.");
        }
    };
